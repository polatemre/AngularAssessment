...
export const USERROUTES: RouteInfo[] = [ 
  { path: '/kitap-islemleri', title: 'Kitap İşlemleri', icon: 'auto_stories', class: '', claim: "GetBooksQuery" },
  { path: '/ogrenci-islemleri', title: 'Öğrenci İşlemleri', icon: 'person', class: '', claim: "GetStudentsQuery" },
  { path: '/kitap-atama-islemleri', title: 'Kitap Atama İşlemleri', icon: 'local_library', class: '', claim: "GetAssignsQuery" }
];
